            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div style="display:flex;flex-direction:column;gap:0.5rem;">
                        ...
                        <a href="{{ route('admin.templates.preview', $template) }}" target="_blank" class="btn-outline">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:14px;height:14px;">
                        ...
                        <form action="{{ route('admin.templates.destroy', $template) }}" method="POST"
                              onsubmit="return confirm('¿Eliminar esta plantilla y todos sus elementos?')" style="margin:0;">
                            @csrf @method('DELETE')
