{{-- resources/views/admin/cursos/alumnos/import.blade.php --}}
<x-app-layout>
    <x-slot name="header">
    ...
    <style>
        ...
        .col-row { display:flex; flex-direction:column; gap:2px; margin-bottom:0.85rem; padding-bottom:0.85rem; border-bottom:1px solid #F0F4FA; }
        ...
        .col-desc { font-size:0.78rem; color:#64748b; }
        .col-example { font-size:0.73rem; color:#94A3B8; font-style:italic; }
    ...
    <div class="page-grid">
        ...
        <div class="form-card">
            ...
            <form method="POST" action="{{ route('admin.cursos.alumnos.importar.store', $curso) }}"
                ...
                <div class="drop-zone" id="drop-zone">
                    ...
                    <div class="drop-hint">Formatos aceptados: .csv &nbsp;·&nbsp; Máx. 4 MB</div>
                ...
                <div style="display:flex;gap:0.75rem;margin-top:1.25rem;align-items:center;">
                    ...
                    <a href="{{ route('admin.cursos.alumnos.plantilla', $curso) }}" class="btn-download" style="margin-left:auto;">
            ...
            <div class="notice" style="margin-top:1.5rem;">
                <strong>Contraseña inicial</strong> para alumnos nuevos: generada automáticamente.
                Pide al alumno que la cambie al primer acceso, o usa la pantalla de edición para actualizarla.
            </div>
        </div>

        {{-- Panel lateral: columnas --}}
        <div>
            <div class="info-card">
                ...
                <div class="info-card-body">
                    ...
                    <div class="col-row">
                        ...
                        <div class="col-desc">Nombre y apellidos del alumno.</div>
                        <div class="col-example">Ej: Juan García López</div>
                    </div>

                    <div class="col-row">
                        <div><span class="col-name">username</span></div>
                        <div class="col-desc">Usuario único. Si ya existe, se usa esa cuenta. Si está vacío, se genera uno automáticamente.</div>
                        <div class="col-example">Ej: jgarcia</div>
                    </div>

                    <div class="col-row">
                        <div><span class="col-name">estado</span></div>
                        <div class="col-desc">
                            Estado de inscripción. Valores válidos:<br>
                            <code style="font-size:0.75rem;">inscrito</code> · <code style="font-size:0.75rem;">en_curso</code> · <code style="font-size:0.75rem;">completado</code> · <code style="font-size:0.75rem;">baja</code>
                        </div>
                        <div class="col-example">Default: inscrito</div>
                    </div>

                    <div class="col-row">
                        <div><span class="col-name">fecha_completado</span></div>
                        <div class="col-desc">Fecha en que el alumno terminó el curso. Solo aplica si estado es <code style="font-size:0.75rem;">completado</code>.</div>
                        <div class="col-example">Ej: 2026-06-15 (YYYY-MM-DD)</div>
                    </div>
                    ...
                    <div style="background:#F0FDF4;border:1px solid #BBF7D0;border-radius:8px;padding:0.75rem;margin-top:0.5rem;font-size:0.78rem;color:#15803D;">
                        <strong>Alumno ya inscrito:</strong> si el username/nombre ya está en este curso, se actualiza su estado en lugar de duplicarlo.
                    </div>
                </div>
            </div>
        </div>
