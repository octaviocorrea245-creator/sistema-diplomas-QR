                            ...
                            <td>
                                <div style="display:flex;align-items:center;gap:10px;">
                                    @if($alumno->avatar_url)
                                        <img src="{{ $alumno->avatar_url }}" alt="Avatar" class="avatar-sm" style="object-fit:cover;">
                                    @else
                            ...
                            <td style="text-align:right;">
                                <div style="display:flex;gap:1rem;justify-content:flex-end;align-items:center;">
                                    ...
                                    <form method="POST" action="{{ route('admin.cursos.alumnos.destroy', [$curso, $alumno]) }}"
                                          onsubmit="return confirmAction(event, '¿Dar de baja a {{ $alumno->display_name }} del curso?')" style="margin:0;">
                                        @csrf @method('DELETE')
            ...
            @foreach($alumnos as $alumno)
                ...
                <div class="alumno-card">
                    ...
                    <div class="alumno-card-footer">
                        ...
                        <a href="{{ route('admin.cursos.alumnos.edit', [$curso, $alumno]) }}" class="action-link link-edit">Editar</a>
                        <form method="POST" action="{{ route('admin.cursos.alumnos.destroy', [$curso, $alumno]) }}"
                              onsubmit="return confirmAction(event, '¿Dar de baja a {{ $alumno->display_name }}?')"
