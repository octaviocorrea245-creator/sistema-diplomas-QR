                    ...
                    @if($curso->template)
                        ...
                        <div class="template-thumb-wrap">
                            @if($tpl->background_image)
                                <img src="{{ asset($tpl->background_image) }}" class="template-thumb" alt="{{ $tpl->nombre }}">
                            @else
                        ...
                        <div class="template-actions">
                            ...
                            <form action="{{ route('admin.templates.destroy', $tpl) }}" method="POST"
                                  onsubmit="return confirmAction(event, '¿Eliminar la plantilla «{{ $tpl->nombre }}»?')" style="display:contents;">
                                @csrf @method('DELETE')
