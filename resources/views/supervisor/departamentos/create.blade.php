            ...
            <form action="{{ route('supervisor.departamentos.store') }}" method="POST" style="padding:1.5rem;">
                ...
                <div style="margin-bottom:1.25rem;">
                    ...
                    <div style="display:flex; align-items:center; gap:10px;">
                        <input type="color" name="color" id="color" value="{{ old('color', '#03A9F4') }}"
                        ...
                        <div id="color-preview"
                             style="width:100%; height:48px; border-radius:8px; background:{{ old('color', '#03A9F4') }}; border:1.5px solid #D1D5DB; transition:background 0.15s;"></div>
                    </div>
                    @error('color')
                        <p style="color:#C0392B; font-size:0.8rem; margin-top:0.35rem;">{{ $message }}</p>
                    @enderror
